...
public class CubeRobot {
    ...
    private static class SceneGraph {
    	private Mesh mesh;
    	private ShaderProgram shader;
    	private Texture texture;
    	private Matrix4f transform;
    	
    	private List<SceneGraph> children;
    	
    	public SceneGraph(Mesh mesh, ShaderProgram shader, Texture texture, Matrix4f transform) {
    		this.mesh = mesh;
    		this.shader = shader;
    		this.texture = texture;
    		this.transform = transform;
    		
    		this.children = new ArrayList<SceneGraph>();
    	}
    	
    	public void addChild(SceneGraph child) {
    ...
    private SceneGraph body;
    private SceneGraph rightArm;
    private SceneGraph leftArm;
    private SceneGraph rightLeg;
    private SceneGraph leftLeg;
    private SceneGraph head;
 ...
 */
    ...
    private SceneGraph initializeBodyPart(Texture texture) {
    	...
    	return new SceneGraph(mesh, shader, texture, transform);
    }

    
    private SceneGraph initializeBodyPart(String texturePath) {
	...
	public CubeRobot() {
		...
		floor = initializeBodyPart("resources/cubemap_head_new.png");
		Matrix4f floorTransform = floor.getTransform();
		floorTransform.translate(0, -2.8f, 0);
		floorTransform.scale(10, 0.2f, 10);
