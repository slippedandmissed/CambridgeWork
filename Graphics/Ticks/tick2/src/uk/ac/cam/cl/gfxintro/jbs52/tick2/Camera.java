 ...
 * always directed towards point 0,0,0.
 *
 * The class facilitates computation of the view and projection matrices for a
 * camera that is rotating around an object located at the origin.
 */
public class Camera {
	...
	public Camera(double aspect_ratio, float fov_y) {
		...
		this.azimuth = 0;// (float)Math.PI / 4;
		this.elevation = 0;// (float)Math.PI / 4;
		this.distance = 8;
		this.fov_y = fov_y;
	}
